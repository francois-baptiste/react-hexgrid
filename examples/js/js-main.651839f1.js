!(function (e) {
  ...
  var n = {};
  return (
    (t.m = e), (t.c = n), (t.p = "/react-hexgrid/examples/drag-and-drop/"), t(0)
  );
})(
  (function (e) {
    for (var t in e)
    ...
    [222, 4, 188, 54, 193, 189, 190, 18, 191, 194, 195, 2],
    [227, 4, 11, 2, 91, 89],
    3,
    [227, 36, 93, 13, 96, 94],
    [233, 210],
    ...
    function (e, t, n) {
      ...
      function c(e) {
        return !(
          !e ||
          (e.nodeType !== D && e.nodeType !== R && e.nodeType !== A)
        );
      }
      function p(e) {
        var t = o(e),
          ...
          u(t, [
            {
              ...
              value: function () {
                return l.default.createElement(
                  "div",
                  { className: "app" },
                  l.default.createElement("h2", null, "Drag & drop"),
                  ...
                  l.default.createElement(
                    c.HexGrid,
                    { width: 1600, height: 1e3, viewBox: "-50 -50 100 100" },
          ...
          u(t, [
            {
              key: "onDrop",
              value: function (e, t, n) {
                var r = this.state.hexagons,
                  o = r.map(function (e) {
                    return (
                      c.HexUtils.equals(t.state.hex, e) &&
                        ((e.image = n.data.image), (e.text = n.data.text)),
                      e
                    );
                  });
                this.setState({ hexagons: o });
              },
            },
            {
              key: "onDragStart",
              value: function (e, t) {
                t.props.data.text || e.preventDefault();
              },
            },
            {
              key: "onDragOver",
              value: function (e, t) {
                var n = this.state.hexagons.filter(function (e) {
                    return e.blocked;
                  }),
                  r = n.find(function (e) {
                    return c.HexUtils.equals(t.state.hex, e);
                  }),
                  o = t.props.data.text;
                  ...
                  t.map(function (t, n) {
                    return l.default.createElement(
                      c.Hexagon,
                      {
                        ...
                        r: t.r,
                        s: t.s,
                        className: t.blocked ? "blocked" : null,
                        fill: t.image ? c.HexUtils.getID(t) : null,
                        data: t,
                        onDragStart: function (t, n) {
                          return e.onDragStart(t, n);
                        },
                        onDragEnd: function (t, n, r) {
                          return e.onDragEnd(t, n, r);
                        },
                        onDrop: function (t, n, r) {
                          return e.onDrop(t, n, r);
                        },
                        onDragOver: function (t, n) {
                          return e.onDragOver(t, n);
                        },
                      },
                      l.default.createElement(
                        c.Text,
                        null,
                        t.text || c.HexUtils.getID(t)
                      ),
                      t.image &&
                        l.default.createElement(c.Pattern, {
                          id: c.HexUtils.getID(t),
                          link: t.image,
                        })
                    );
                  })
      ...
      var p = (function (e) {
        function t(e) {
          ...
          var n = i(
            ...
            r = c.GridGenerator.parallelogram(-1, 1, -1, 2).map(function (
              e,
              t
            ) {
              return Object.assign({}, e, {
                text: "Cat #" + t,
                image: "http://lorempixel.com/400/400/cats/" + (t % 10) + "/",
              });
            });
          return (n.state = { hexagons: r }), n;
        }
        return (
          a(t, e),
          u(t, [
            { key: "onDragStart", value: function (e, t) {} },
            {
              key: "onDragEnd",
              value: function (e, t, n) {
                if (n) {
                ...
                return l.default.createElement(
                  ...
                  t.map(function (t, n) {
                    return l.default.createElement(
                      ...
                      l.default.createElement(c.Text, null, t.text),
                      !!t.image &&
                        l.default.createElement(c.Pattern, {
                          id: c.HexUtils.getID(t),
                          link: t.image,
            ...
            for (r in t) {
              ...
              if (t.hasOwnProperty(r) && s !== l && (null != s || null != l))
                if (r === H)
                  ...
                  V.hasOwnProperty(r) || E.setValueForAttribute(L(this), r, s);
    ...
    function (e, t, n) {
      "undefined" == typeof Promise &&
        (n(119).enable(), (window.Promise = n(118))),
        n(197),
        (Object.assign = n(4));
    },
    42,
    [221, 19],
    [223, 187, 18, 7, 196],
    [224, 19, 4, 54, 18, 90, 55, 22, 1, 2],
    [226, 18],
    [229, 18, 90, 192, 7, 92, 2],
    155,
    [230, 4, 54, 55, 22],
    160,
    [231, 19, 18, 1],
    [232, 19, 11, 89, 92, 1, 186, 2],
    function (e, t) {
      !(function (e) {
        "use strict";
        function t(e) {
    ...
    [222, 36, 211, 61, 216, 212, 213, 20, 214, 217, 218, 13],
    [223, 209, 20, 59, 219],
    [224, 28, 36, 61, 20, 95, 62, 60, 27, 13],
    [226, 20],
    [229, 20, 95, 215, 59, 97, 13],
    155,
    [230, 36, 61, 62, 60],
    function (e, t) {
      "use strict";
    ...
    function (e, t, n, r, o, i, a, u, s) {
      ...
      (c.prototype = Error.prototype), (e.exports = D);
    },
    function (e, t, n, r, o, i, a) {
      "use strict";
      function u(e, t, n) {
...
//# sourceMappingURL=main.651839f1.js.map
