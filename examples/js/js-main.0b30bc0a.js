!(function (e) {
  ...
  var n = {};
  return (
    (t.m = e), (t.c = n), (t.p = "/react-hexgrid/examples/templates/"), t(0)
  );
})(
  (function (e) {
    for (var t in e)
      ...
      var d = (function (e) {
        function t(e) {
          ...
          var n = i(
            ...
            r = f.default.hexagon,
            a = c.GridGenerator.getGenerator(r.map),
            u = a.apply(n, r.mapProps);
          return (n.state = { hexagons: u, config: r }), n;
        }
        return (
          a(t, e),
          u(t, [
            {
              ...
              value: function (e) {
                var t = e.currentTarget.value,
                  n = f.default[t],
                  r = c.GridGenerator.getGenerator(n.map),
                  o = r.apply(this, n.mapProps);
                this.setState({ hexagons: o, config: n });
              },
            },
            {
              key: "render",
              value: function () {
                ...
                return l.default.createElement(
                  ...
                  l.default.createElement(
                    "h2",
                    null,
                    "Select grid type and configuration from dropdown."
                  ),
                  l.default.createElement(
                    "div",
                    null,
                    l.default.createElement("strong", null, "Template: "),
                    l.default.createElement(
                      "select",
                      {
                        onChange: function (t) {
    ...
    function (e, t) {
      e.exports = {
        hexagon: {
          width: 1e3,
          height: 800,
          layout: { width: 8, height: 8, flat: !1, spacing: 1.02 },
          origin: { x: 0, y: 0 },
          map: "hexagon",
          mapProps: [3],
        },
        triangle: {
          width: 1e3,
          height: 800,
          layout: { width: 9, height: 9, flat: !1, spacing: 1.05 },
          origin: { x: -45, y: -35 },
          map: "triangle",
          mapProps: [5],
        },
        parallelogram: {
          width: 1e3,
          height: 800,
          layout: { width: 7, height: 7, flat: !0, spacing: 1.05 },
          origin: { x: 0, y: 0 },
          map: "parallelogram",
          mapProps: [-2, 2, -2, 2],
        },
        rectangle: {
          width: 1e3,
          height: 800,
          layout: { width: 6, height: 6, flat: !1, spacing: 1.02 },
          origin: { x: -45, y: -40 },
          map: "rectangle",
          mapProps: [10, 10],
        },
        orientedRectangle: {
          width: 1e3,
          height: 800,
          layout: { width: 6, height: 6, flat: !1, spacing: 1.1 },
          origin: { x: -45, y: -15 },
    ...
    function (e, t, n) {
      ...
      function c(e, t) {
        (M = e),
          ...
          Object.defineProperty(M, "value", A),
          M.attachEvent
    ...
    function (e, t, n) {
      "undefined" == typeof Promise &&
        (n(116).enable(), (window.Promise = n(115))),
        n(183),
        (Object.assign = n(4));
    },
    function (e, t) {
    ...
    function (e, t, n, r, o, i, a) {
      ...
      function y(e) {
        var t = [];
        return d(e, t, null, b.thatReturnsArgument), t;
      }
      var g = n(r),
        _ = n(o),
        b = n(i),
    ...
    function (e, t, n, r, o, i, a, u, s) {
      ...
      function _(e) {
        function t(t, n, r, o, i) {
          for (var a = 0; a < e.length; a++) {
            var u = e[a];
            if (null == u(t, n, r, o, i, O)) return null;
          }
          var s = M[o];
          return new c(
      ...
      (c.prototype = Error.prototype), (e.exports = R);
    },
    function (e, t, n, r, o, i, a) {
      "use strict";
      function u(e, t, n) {
      ...
      function p(e, t, n, r) {
        ...
        if (Array.isArray(e))
          ...
          if (f) {
            ...
            if (f !== e.entries)
              for (var C = 0; !(_ = b.next()).done; )
                (i = _.value), (a = s + c(i, C++)), (u += p(i, a, n, r));
            else
              for (; !(_ = b.next()).done; ) {
                var E = _.value;
                E &&
...
//# sourceMappingURL=main.0b30bc0a.js.map
