!(function (e) {
  ...
  var n = {};
  return (t.m = e), (t.c = n), (t.p = "/react-hexgrid/"), t(0);
})(
  (function (e) {
    for (var t in e)
    ...
    function (e, t, n) {
      ...
      var i = n(4),
        a = n(11),
        u = (n(2), n(81), Object.prototype.hasOwnProperty),
        s = n(79),
    ...
    function (e, t, n) {
      ...
      var F = {
        ...
        unmountComponentAtNode: function (e) {
          ...
          return (
            delete U[t._instance.rootID], P.batchedUpdates(s, t, e, !1), !0
          );
        },
    ...
    function (e, t, n) {
      ...
      !(function (a, u) {
        ...
        var o = n(t),
          ...
          a = function e(t, n, o, i, a, u, s, l, c) {
            r(this, e),
              (this.f0 = t),
              (this.f1 = n),
              (this.f2 = o),
          ...
          u = (function () {
            function e(t, n) {
              r(this, e),
                (this.name = t.name || ""),
                (this.orientation = t.flat ? e.LAYOUT_FLAT : e.LAYOUT_POINTY),
                (this.size = new o.default(t.width, t.height)),
                (this.origin = n || new o.default(0, 0)),
                (this.spacing = t.spacing || 1);
            }
            return (
              i(e, [
                {
                  ...
                  value: function (e) {
                    var t =
                      (2 * Math.PI * (e + this.orientation.startAngle)) / 6;
                    return new o.default(
                      this.size.x * Math.cos(t),
                      this.size.y * Math.sin(t)
                    );
                  },
                },
                {
                  ...
                  value: function (e) {
                    var t = this,
                      ...
                      r = new o.default(0, 0);
                    return (
                      Array.from(new Array(6), function (e, i) {
                        var a = t.getPointOffset(i),
                          u = new o.default(r.x + a.x, r.y + a.y);
                        n.push(u);
                      }),
                      n
                    );
        ...
        function t(e) {
          ...
          var n = i(
            ...
            r = {
              width: 1200,
              height: 1e3,
              layout: { width: 6, height: 6, flat: !0, spacing: 1 },
              origin: { x: 0, y: 0 },
              map: "hexagon",
              mapProps: [4],
            },
            a = c.HexGrid.generate(r);
          return (
            (n.state = {
              grid: a,
              config: r,
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this.state,
                  ...
                  o = n.grid;
                r.end = e;
                var i = o.hexagons.map(function (t) {
                  return (
                    (t.props.className =
                      c.HexUtils.distance(e, t) < 2 ? "active" : ""),
                    (t.props.className += e.q === t.q ? " q " : ""),
                    (t.props.className += e.r === t.r ? " r " : ""),
                    (t.props.className += e.s === t.s ? " s " : ""),
                    t
                  );
                });
                (o.hexagons = i), this.setState({ path: r, grid: o });
              },
            },
            {
              key: "render",
              value: function () {
                ...
                return l.default.createElement(
                  ...
                  l.default.createElement(c.HexGrid, {
                    width: r.width,
                    height: r.height,
                    hexagons: n.hexagons,
                    layout: n.layout,
            ...
            for (r in t) {
              ...
              if (t.hasOwnProperty(r) && s !== l && (null != s || null != l))
                if (r === q)
                  ...
                  H.hasOwnProperty(r) || E.setValueForAttribute(j(this), r, s);
    ...
    function (e, t, n) {
      var r, o, i;
      !(function (a, u) {
        (o = [t, n(12), n(31), n(173), n(175), n(76), n(168)]),
          (r = u),
          (i = "function" == typeof r ? r.apply(t, o) : r),
          !(void 0 !== i && (e.exports = i));
      })(this, function (e, t, n, r, o, i, a) {
        "use strict";
        function u(e) {
          return e && e.__esModule ? e : { default: e };
        }
        ...
        (w.generate = function (e, t) {
          var n = new h.default(e.layout, e.origin),
            r = v.default.getGenerator(e.map),
            o = r.apply(void 0, e.mapProps);
          return { hexagons: o, layout: n };
        }),
          (w.propTypes = {
            width: b.isRequired,
            height: b.isRequired,
            actions: _.isRequired,
            layout: _.isRequired,
            hexagons: E.isRequired,
            viewBox: C,
            path: _,
          }),
          (w.defaultProps = {
    ...
    function (e, t, n) {
      ...
      !(function (a, u) {
              ...
              s(t, [
                {
                  ...
                  value: function () {
                    var e = this.props,
                      ...
                      n = e.id,
                      r = e.layout;
                    if (t.props == {} || "undefined" == typeof t.props.image)
                      return null;
                    var o = r.size,
                      i = o.x,
                      a = o.y;
                    return u.default.createElement(
                      ...
                      u.default.createElement(
                        ...
                        u.default.createElement("image", {
                          xlinkHref: t.props.image,
                          x: 0,
                          y: 0,
                          width: 2 * i,
                          height: 2 * a,
        ...
        (f.propTypes = { hex: c.isRequired, id: p.isRequired, layout: c }),
          (e.default = f);
      });
    },
    function (e, t, n) {
      ...
      !(function (a, u) {
              ...
              s(t, [
                {
                  ...
                  value: function (e, t) {
                    var n = e.split(","),
                      r = t.split(","),
                      o = { x: parseFloat(n[0]), y: parseFloat(n[1]) },
                      i = { x: parseFloat(r[0]), y: parseFloat(r[1]) },
                      a = { x: (o.x + i.x) / 2, y: (o.y + i.y) / 2 },
                      u = { x: 0.7 * (i.x + a.x), y: 0.7 * (i.y + a.y) };
                    return [i, a, u]
                      .map(function (e) {
                        return e.x + "," + e.y;
                      })
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this,
                      t = this.props.hex;
                    if (t.props == {} || "undefined" == typeof t.props.arrows)
                      return null;
                    var n = t.props.arrows,
                      r = this.props.points.split(" "),
                      o = r.map(function (t, o) {
                        if (n[o]) {
                          var i = o == r.length - 1 ? r[0] : r[o + 1];
                          return e.createPointerArc(t, i);
                        }
                      });
                    return u.default.createElement(
                      "g",
                      null,
                      o.map(function (e, t) {
                        return u.default.createElement("path", { d: e });
                      })
                    );
                  },
                },
        ...
        (f.propTypes = { hex: c.isRequired, points: p.isRequired }),
          (e.default = f);
      });
    },
    function (e, t, n) {
              ...
              s(t, [
                {
                  ...
                  value: function () {
                    var e = this.props,
                      ...
                      r = e.useFill,
                      o = r ? "url(#" + t + ")" : null;
                    return u.default.createElement("polygon", {
                      points: n,
                      fill: o,
                    });
                  },
    ...
    function (e, t, n) {
      var r, o, i;
      !(function (a, u) {
        (o = [t, n(12), n(86), n(170), n(172), n(171), n(174), n(17)]),
          (r = u),
          (i = "function" == typeof r ? r.apply(t, o) : r),
          !(void 0 !== i && (e.exports = i));
      })(this, function (e, t, n, r, o, i, a, u) {
        "use strict";
        function s(e) {
          return e && e.__esModule ? e : { default: e };
        }
              ...
              b(t, [
                {
                  key: "getPoints",
                  value: function (e) {
                    var t = this.props.layout.getPolygonPoints(e);
                    return t
                      .map(function (e) {
                        return e.x + "," + e.y;
                      })
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return Object.assign({}, e, this.props.actions);
                  },
                },
                {
                  key: "render",
                  value: function () {
                    var e = this,
                      ...
                      r = t.layout,
                      o = this.getActions(),
                      i = r.name + g.default.getID(n),
                      a = n.props.text ? n.props.text : g.default.getID(n),
                      u = this.getPoints(n),
                      s = n.props,
                      l = s.className,
                      c = s.useFill;
                    return f.default.createElement(
                      "g",
                      {
                        className: (0, d.default)("shape-group", l),
                        transform: this.translate(),
                        draggable: "true",
                        onMouseEnter: function (t) {
                          return o.onMouseEnter(e.props.hex, t);
                        },
                        onMouseLeave: function (t) {
                          return o.onMouseLeave(e.props.hex, t);
                        },
                        onDragStart: function (t) {
                          return o.onDragStart(e.props.hex, t);
                        },
                        onDragEnd: function (t) {
                          return o.onDragEnd(e.props.hex, t);
                        },
                        onDragOver: function (t) {
                          return o.onDragOver(e.props.hex, t);
                        },
                        onDrop: function (t) {
                          return o.onDrop(e.props.hex, t);
                        },
                        onClick: function (t) {
                          return o.onClick(e.props.hex, t);
                        },
                      },
                      ...
                      f.default.createElement(m.default, { hex: n, points: u }),
                      f.default.createElement(y.default, { text: a })
                    );
                  },
                },
              ]),
    ...
    function (e, t, n) {
      ...
      !(function (a, u) {
        ...
        (l.propTypes = { text: s }), (e.default = l);
      });
    },
    function (e, t, n) {
      var r, o, i;
      !(function (a, u) {
              ...
              l(t, [
                {
                  ...
                  value: function () {
                    ...
                    return (i += n
                      .map(function (t) {
                        var n = s.default.hexToPixel(t, e.props.layout);
                        return " " + n.x + "," + n.y + " ";
                      })
                      .join("L"));
                  },
        ...
        (p.propTypes = { start: c, end: c, layout: c.isRequired }),
          (e.default = p);
      });
    },
    function (e, t, n) {
      ...
      !(function (a, u) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.HexUtils = e.Layout = e.Hex = e.HexGrid = void 0);
        var a = i(t),
          u = i(n),
          s = i(r),
          l = i(o);
        (e.HexGrid = u.default),
          (e.Hex = a.default),
          (e.Layout = s.default),
          (e.HexUtils = l.default);
      });
    },
    function (e, t, n) {
      "undefined" == typeof Promise &&
        (n(102).enable(), (window.Promise = n(101))),
        n(179),
        (Object.assign = n(178));
    },
    function (e, t) {
...
//# sourceMappingURL=main.d9ea25fc.js.map
